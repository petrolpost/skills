...
- `.petrelpost/docs/collaboration/roles/overview.md`
- `.petrelpost/docs/collaboration/role-tasks/TaskRegistry.md`
...
- 目前只覆盖角色与任务两层,不生成项目决策日志、路线图等其他文档层——如果项目已有类似机制,建议在 `overview.md` 里引用而非重
