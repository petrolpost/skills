...
- `docs/collaboration/roles/overview.md` — who does what, handoff rules, escalation
- `docs/tasks/TaskRegistry.md` — current task status

If you are acting as one of these roles, also read your own role file under `docs/collaboration/roles/{your-role-slug}.md` before proceeding — it defines what you can decide unilaterally and what must be escalated.
